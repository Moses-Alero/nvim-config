...
set shell=/bin/bash
set backup
set backupdir=C:/Users/HP/Documents/vimbackups//
set writebackup
call plug#begin()
...
let g:coc_global_extensions = ['coc-emmet', 'coc-css', 'coc-html', 'coc-json', 'coc-prettier', 'coc-tsserver', 'coc-highlight', 'coc-go']
